File 0-print_list.c is a funtion that prints all the elements of a list_t list.
...
File lists.h is the header file containing the definition of the list_t struct and all the prototype of the above functions.
